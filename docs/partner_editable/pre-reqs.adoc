...
This Quick Start deploys a CICD pipeline using AWS CodePipeline from source code hosted on GitHub. As AWS CodePipeline requires private access to GitHub repositories, you must have a GitHub account and have completed the following steps:
